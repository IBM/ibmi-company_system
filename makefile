...
all: .logs .evfevent library $(PREPATH)/APP.BNDDIR $(PREPATH)/DEPTS.PGM $(PREPATH)/EMPLOYEES.PGM $(PREPATH)/MYPGM.PGM $(PREPATH)/NEWEMP.PGM $(PREPATH)/POPEMP.PGM $(PREPATH)/POPDEPT.PGM
...
$(PREPATH)/EMPLOYEES.PGM: $(PREPATH)/EMPLOYEE.FILE $(PREPATH)/EMPS.FILE $(PREPATH)/APP.BNDDIR
