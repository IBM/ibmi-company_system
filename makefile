...
all: .logs .evfevent library $(PREPATH)/APP.BNDDIR $(PREPATH)/DEPTS.PGM $(PREPATH)/MYPGM.PGM $(PREPATH)/NEWEMP.PGM $(PREPATH)/EMPLOYEES.PGM $(PREPATH)/POPEMP.PGM $(PREPATH)/POPDEPT.PGM
